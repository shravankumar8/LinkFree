      ...
      <div className="container-tight">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground">
              The open-source alternative to Linktree that gives you full control
              over your online presence. Customize your page, share your links,
              and grow your audience—all for free.
            </p>
        ...
        <div className="border-t border-gray-200 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} LinkFree. Built with <Heart className="inline h-3 w-3 text-red-500" /> by the community.
          </p>
